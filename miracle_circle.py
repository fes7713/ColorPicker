...
from KClass.Spline_Interpolation_2 import Color_Interpolation, Color_Interpolation_2D
...
class Ui_Form(QtWidgets.QWidget):
    ...
    def display_color_update(self):
        ...
        r, g, b = cs.hsv_to_rgb(self.hueSlider.value() / 360, 1, 0)
        print(self.hueSlider.value() / 360)
        code_bottom = '#{:02x}{:02x}{:02x}'.format(int(r * 360), int(g * 255), int(b * 255))
        r, g, b = cs.hsv_to_rgb(self.hueSlider.value() / 360, 0, 1)
        code_top_left = '#{:02x}{:02x}{:02x}'.format(int(r * 360), int(g * 255), int(b * 255))

        colors = Color_Interpolation_2D(items[0], code_top_left, code_bottom, code_bottom, self.nStepsSlider.value())
        # print("Value : " + str(self.nStepsSlider.value()))
