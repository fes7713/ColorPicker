...
class Ui_MainWindow(object):
    ...
    def display_color_update(self):
        ...
        code_bottom_left = [self.hueSlider.value(), 255, 1]

        r, g, b = cs.hsv_to_rgb(self.hueSlider.value() / 360, 0.01, 255)
        code_top_left = [self.hueSlider.value(), 1, 255]

        r, g, b = cs.hsv_to_rgb(self.hueSlider.value() / 360, 1, 255)
        code_top_right = [self.hueSlider.value(), 255, 255]

        colors = Color_Interpolation_HSV_2D(code_top_right, code_top_left, code_bottom_left, code_bottom_left, self.nStepsSlider.value())
